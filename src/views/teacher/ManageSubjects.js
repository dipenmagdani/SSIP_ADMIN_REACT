          ...
          <CCard className="mb-4">
            ...
            <CCardBody>
              <CTable align="middle" className="mb-0 border" hover responsive>
                ...
                <CTableBody>
                  {subjectsToRender.length > 0 ? subjectsToRender.map((item, index) => (
                    <CTableRow v-for="item in tableItems" key={index}>
                      ...
                      <CTableDataCell  className='text-center'>
                        <div>{item.selected ? (<CFormCheck id="flexCheckChecked" defaultChecked onChange={(e) => {subjectSelectionChanged(e.target.checked,item)}}/>):(<CFormCheck id="flexCheckDefault" onChange={(e) => {subjectSelectionChanged(e.target.checked,item)}}/> )}</div>
                      </CTableDataCell>
                    </CTableRow>
                  )) : null}
                </CTableBody>
