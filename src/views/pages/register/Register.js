  ...
  return (
    <div className="h-screen bg-center bg-no-repeat sm:p-20 p-6" style={{background:'black'}}>
      ...
      <div className="text-white sm:w-full">
        ...
        <div className='mb-3'>
          <span style={{color:'rgb(255, 163, 26)'}}>Warning: This credentials will be used to Log-You-In from now on </span>
        </div> 
          <div className="relative border-b-2	border-slate-500 z-0 w-full mb-5 group">
            <input type="text" name="floating_enrollment" id="floating_enrollment" className="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer" placeholder=" " required {...register('enrollment')}/>
