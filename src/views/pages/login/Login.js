...
export default function Login(){
  ...
  return (
    <div className="h-screen bg-center bg-no-repeat sm:p-10 p-2 overflow-hidden box-border" style={{background:'black'}}>
      <section className="w-full h-full flex justify-center items-center box-border rounded-md bg-clip-padding backdrop-filter backdrop-blur-sm bg-opacity-20 border border-gray-100 flex-1 overflow-hidden" style={{backgroundImage:'url(/images/background2.jpg)'}}>
      <div className="text-white sm:w-full w-full mx-3">        
